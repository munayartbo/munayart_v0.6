...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2024 a las 04:05:03
...
INSERT INTO `artesano` (`CodArtesano`, `Descripcion`, `AniosExp`, `FechaRegistro`, `CodComunidad`) VALUES
(1, '', 0, '2024-09-23 18:29:06', NULL);
...
--
ALTER TABLE `administrador`
  MODIFY `CodAdmi` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `comunidad`
  MODIFY `CodComunidad` int(11) NOT NULL AUTO_INCREMENT;
